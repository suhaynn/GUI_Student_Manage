...
class DatabaseChecker:
    ...
    def create_user_table(self):
        ...
        if result:
            # db = Database()
            # sql = "CREATE TABLE user (id INT AUTO_INCREMENT PRIMARY KEY, username VARCHAR(255) DEFAULT '', password VARCHAR(255) DEFAULT '123456', user_type INT DEFAULT 0, stu_id INT DEFAULT NULL, tea_id INT DEFAULT NULL, chinese_score INT DEFAULT NULL, math_score INT DEFAULT NULL, english_score INT DEFAULT NULL)"
            # db.execute(sql)

            # db = Database()
            # sql = "CREATE TABLE user (id INT AUTO_INCREMENT PRIMARY KEY, username VARCHAR(255) DEFAULT '', password VARCHAR(255) DEFAULT '123456', user_type INT, stu_id INT DEFAULT NULL, tea_id INT DEFAULT NULL, chinese_score INT DEFAULT NULL, math_score INT DEFAULT NULL, english_score INT DEFAULT NULL)"
            # db.execute(sql)
            # sql = "ALTER TABLE user ALTER COLUMN user_type SET DEFAULT 0"
            # db.execute(sql)
    ...
    # # 修改数据库字段顺序的SQL语句
    #     sql = "ALTER TABLE user MODIFY id INT NOT NULL AUTO_INCREMENT FIRST, MODIFY username VARCHAR(50) NOT NULL AFTER id, MODIFY password VARCHAR(50) NOT NULL AFTER username, MODIFY user_type VARCHAR(10) NOT NULL AFTER password, MODIFY stu_id VARCHAR(20) DEFAULT NULL AFTER user_type, MODIFY tea_id INT DEFAULT NULL AFTER stu_id, MODIFY chinese_score INT DEFAULT NULL AFTER tea_id, MODIFY math_score INT DEFAULT NULL AFTER chinese_score, MODIFY english_score INT DEFAULT NULL AFTER math_score"
    #     db = Database()
    #     db.execute(sql)
    #     db.close()
    # def modify_field_order(self):
    #     # 修改数据库字段顺序的SQL语句
    #     sql = "ALTER TABLE user MODIFY id INT(11) NOT NULL AUTO_INCREMENT FIRST, MODIFY username VARCHAR(50) NOT NULL AFTER id, MODIFY password VARCHAR(50) NOT NULL DEFAULT '123456' AFTER username, MODIFY user_type TINYINT(4) NOT NULL DEFAULT 0 AFTER password, MODIFY stu_id VARCHAR(20) DEFAULT NULL AFTER user_type, MODIFY tea_id INT(11) DEFAULT NULL AFTER stu_id, MODIFY chinese_score INT(11) DEFAULT NULL AFTER tea_id, MODIFY math_score INT(11) DEFAULT NULL AFTER chinese_score, MODIFY english_score INT(11) DEFAULT NULL AFTER math_score"
    #     db = Database()
    #     db.execute(sql)
    #     db.close()
    def modify_field_order(self):
        # 修改数据库字段顺序的SQL语句
        sql = "ALTER TABLE user MODIFY id INT NOT NULL AUTO_INCREMENT FIRST, MODIFY username VARCHAR(50) NOT NULL AFTER id, MODIFY password VARCHAR(50) NOT NULL DEFAULT '123456' AFTER username, MODIFY user_type VARCHAR(10) NOT NULL DEFAULT '0' AFTER password, MODIFY stu_id VARCHAR(20) DEFAULT NULL AFTER user_type, MODIFY tea_id INT DEFAULT NULL AFTER stu_id, MODIFY chinese_score INT DEFAULT NULL AFTER tea_id, MODIFY math_score INT DEFAULT NULL AFTER chinese_score, MODIFY english_score INT DEFAULT NULL AFTER math_score"
        db = Database()
        db.execute(sql)
        db.close()
    ...
    def add_data(self):
        ...
        db_config['database'] = 'students'
        db = Database()
        sql = "INSERT INTO user (username, password, user_type, stu_id, tea_id) VALUES ('admin', 'admin', 2, NULL, 1)"
        db.execute(sql)
        db.close()
